...
def plot_overlay(validation_accuracy, training_accuracy, num_epochs, xmin=0):
    fig = plt.figure()
    ax = fig.add_subplot(111)
    ...
    ax.set_title('Compare accuracies on test and validation')
...
def make_plots(data, num_epochs, training_cost_xmin=0,
    ...
    plot_overlay(val_acc, train_acc, num_epochs)
